...
namespace Quest4pet.Controllers
{
    public class tblAdminsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Admin_ID,Admin_Name,Admin_Password,Admin_Email,Admin_Contact")] tblAdmin tblAdmin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Admin_ID,Admin_Name,Admin_Password,Admin_Email,Admin_Contact")] tblAdmin tblAdmin)
        {
            if (ModelState.IsValid)
            {
